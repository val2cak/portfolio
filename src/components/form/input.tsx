...
const Input: FC<Props> = ({
  ...
  return (
    <div className='flex flex-col items-start justify-center text-yellow flex-1 w-full'>
      ...
      <input
        className={`w-full border-b focus:outline-none pl-6 pb-2 bg-transparent text-sm font-normal placeholder:text-yellow text-light placeholder:opacity-70 placeholder:text-sm placeholder:font-normal ${
          errors ? 'border-red' : 'border-yellow focus:border-light'
        }`}
