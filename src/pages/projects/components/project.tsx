...
const Project: FC<Props> = ({
  ...
  return (
    <Link
      href={`projects/${slug}`}
      className={`flex flex-col gap-2 border-2 border-yellow rounded-sm sm:h-[30rem] h-[28rem] 2xl:h-[32rem] sm:w-64 w-80 2xl:w-[24rem] text-yellow sm:hover:border-yellow hover:border-blue sm:hover:text-yellow hover:text-blue sm:hover:scale-100 hover:scale-105`}
    >
      <img
        src={imgUrl}
        alt={imgDescription}
